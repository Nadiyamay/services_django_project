...
class Services(models.Model):
    ...
    name_of_service=models.CharField(max_length=30, help_text="Add name of service", blank=False)
    type_of_service=models.CharField(max_length=30, help_text="Select type of service", blank=False)
